...
import Brand from '../../images/logos/Dark.webp';
    ...
    <header className="w-full px-2 pb-2 pt-3 sm:px-6 lg:px-12">
      <div className="flex items-start justify-between">
        <Link href="/" className="flex items-center py-2">
          <Image src={Brand} width={24} alt="" className="ml-2 mt-0.5 pb-px  border-r border-gray-200" />
          <Image src={Logo} width={24} alt="" />
          <Image src={Name} width={130} alt="" className="ml-2 mt-0.5 hidden sm:block" />
          <h1 className="ml-2 pt-px text-2xl font-bold uppercase tracking-wide text-white">PandaC</h1>
